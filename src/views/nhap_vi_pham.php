...
<div class="w-full px-2 lg:px-4">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center gap-2 mb-3">
    ...
    <div class="flex items-center gap-1.5 flex-wrap" id="toolbar-normal">
      ...
      <a href="/thidua/admin/duyet-vi-pham" class="btn-std btn-std-primary" title="Duyệt vi phạm CTV">
        <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" fill="currentColor" class="bi bi-shield-fill-check" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.8 11.8 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7 7 0 0 0 1.048-.625 11.8 11.8 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.54 1.54 0 0 0-1.044-1.263C10.228.826 9.11.47 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"/></svg>
        Minh chứng tuần
      </a>
        ...
        <tbody id="violation-table-body">
          ...
          <tr data-vi-pham-id="<?= htmlspecialchars((string)($vp['id'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>"
            ...
            <td class="notification-status text-center">
              <?php
                $status = mb_strtolower($vp['trang_thai_thong_bao'] ?? 'chưa tb', 'UTF-8');
                if ($status === 'đã tb gv' || $status === 'đã tb gvcn') {
                ...
                } elseif ($status === 'đã tb hs gvcn' || $status === 'đã tb') {
                    echo '<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-green-100 text-green-800">Đã TB HS & GV</span>';
                } else {
...
<div class="custom-modal-backdrop" id="sendTargetModal">
  <div class="custom-modal-box" style="max-width:480px">
    ...
    <div class="custom-modal-title text-[#224397]">Chọn Đối Tượng Gửi</div>
